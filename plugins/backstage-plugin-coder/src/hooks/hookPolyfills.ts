...
type ReactWithModernHooks = typeof React & {
  // Added in React 18
  useId?: () => string;
};

const recastReact = React as ReactWithModernHooks;

export const useId =
  typeof recastReact.useId === 'undefined' ? useIdPolyfill : recastReact.useId;
